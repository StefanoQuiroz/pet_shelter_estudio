...
const Details = (props) => {
    ...
    return (
        ...
        <Row>
            <h1 style={{fontSize:'2.5trem'}}>Details about: {detail.petName}<Button style={{marginLeft:'20rem'}}color="danger" style={{color:'white'}} onClick={(event)=> deletePet(event, id)}>Adopt{detail.petName}</Button></h1>
        </Row>
        <Row>
